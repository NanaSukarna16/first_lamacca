...
export default function KategoriBarang({ auth, errors, kategori_barang }) {
    function handleDelete(target) {
        Swal.fire({
            title: "Anda yakin ingin menghapus kategori Barang Ini?",
            showDenyButton: true,
            ...
            <div className="py-4">
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        <h1 className="text-xl font-semibold text-gray-900">Kategori Barang</h1>
                            ...
                            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table className="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tbody className="bg-white">
                                        {kategori_barang.data.map((item, idx) => (
                                            <tr
                                                key={idx}
                                            ...
                                            >
                                                ...
                                                <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium space-x-2 sm:pr-6">
                                                    <Link
                                                        href={route("kategori-barang.edit", item.id)}
